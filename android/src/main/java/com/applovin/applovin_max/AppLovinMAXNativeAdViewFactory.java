        ...
        extends PlatformViewFactory
{
    ...
    public PlatformView create(@Nullable final Context context, final int viewId, final Object args)
    {
        ...
        @Nullable
        String nativeAdName = (String) params.get( "native_ad_name" );
        ...
        return new AppLovinMAXNativeAdView( viewId, adUnitId, placement, customData, extraParameters, localExtraParameters, messenger, sdk, context, nativeAdName );
    }
}
