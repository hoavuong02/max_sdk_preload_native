...
class AppLovinMAX {
  ...
  static final Completer<MaxConfiguration> _initializeCompleter =
      Completer<MaxConfiguration>();
  ...
  static NativeAdListener? _nativePreloadAdWithPlacementListener;
  ...
  static Future<MaxConfiguration?> initialize(String sdkKey) async {
    ...
    channel.setMethodCallHandler((MethodCall call) async {
      ...
      final MaxAd? ad =
          arguments.containsKey('networkName') ? createMaxAd(arguments) : null;
      ...
      if ("OnBannerAdLoadedEvent" == method) {
        ...
        _bannerAdListener?.onAdLoadFailedCallback(
            arguments["adUnitId"], createError(arguments));
      ...
      /// MREC Ad Events
        ...
        _mrecAdListener?.onAdLoadFailedCallback(
            arguments["adUnitId"], createError(arguments));
      ...
      /// Interstitial Ad Events
        ...
        _interstitialListener?.onAdLoadFailedCallback(
            arguments["adUnitId"], createError(arguments));
        ...
        _interstitialListener?.onAdDisplayFailedCallback(
            createAd(arguments["ad"]), createError(arguments["error"]));
        ...
        _interstitialListener?.onAdRevenuePaidCallback
            ?.call(createAd(arguments));
      }
      ...
      /// Rewarded Ad Events
        ...
        _rewardedAdListener?.onAdLoadFailedCallback(
            arguments["adUnitId"], createError(arguments));
        ...
        _rewardedAdListener?.onAdDisplayFailedCallback(
            createAd(arguments["ad"]), createError(arguments["error"]));
        ...
        var reward =
            MaxReward(arguments["rewardAmount"], arguments["rewardLabel"]);
        _rewardedAdListener?.onAdReceivedRewardCallback(
            createAd(arguments), reward);
      ...
      /// App Open Ad Events
        ...
        _appOpenAdListener?.onAdLoadFailedCallback(
            arguments["adUnitId"], createError(arguments));
        ...
        _appOpenAdListener?.onAdDisplayFailedCallback(
            createAd(arguments["ad"]), createError(arguments["error"]));
      ...
      /// Widget AdView Ad Events
        ...
        _widgetAdViewAdListener?.onAdLoadedCallback(ad!);
      } else if ("OnWidgetAdViewAdLoadFailedEvent" == method) {
        _widgetAdViewAdListener?.onAdLoadFailedCallback(
            arguments["adUnitId"], createMaxError(arguments));
      }

      ///Preload Native With Placement Events
      else if ("OnPreloadNativeAdWithPlacementLoadedEvent" == method) {
        _nativePreloadAdWithPlacementListener?.onAdLoadedCallback
            .call(createAd(arguments));
      } else if ("OnPreloadNativeAdWithPlacementFailEvent" == method) {
        _nativePreloadAdWithPlacementListener?.onAdLoadFailedCallback
            .call(arguments["adUnitId"], createError(arguments));
      }
    });
    ...
    if (isPlatformSDKInitialized) {
      ...
      _initializeCompleter
          .complete(MaxConfiguration.fromJson(Map<String, dynamic>.from(conf)));
      return _initializeCompleter.future;
    }
  ...
  static void setConsentFlowDebugUserGeography(
      ConsentFlowUserGeography userGeography) {
  ...
  static void setBannerBackgroundColor(
      String adUnitId, String hexColorCodeString) {
  ...
  static void setBannerExtraParameter(
      String adUnitId, String key, String value) {
  ...
  static void setInterstitialExtraParameter(
      String adUnitId, String key, String value) {
  ...
  static void setRewardedAdExtraParameter(
      String adUnitId, String key, String value) {
  ...
  /// Sets an extra parameter to the rewarded ad with the specified [adUnitId].
  static void setAppOpenAdExtraParameter(
      String adUnitId, String key, String value) {
  ...
  static Future<void> destroyWidgetAdView(String placement) {
  ...
  static void setNativePreloadWithPlacementListener(NativeAdListener listener) {
    _nativePreloadAdWithPlacementListener = listener;
  }

  static void preloadNativeAd(String adUnitId, String placement) {
    channel.invokeMethod(
        'preloadNativeAd', {"ad_unit_id": adUnitId, "placement": placement});
  }
